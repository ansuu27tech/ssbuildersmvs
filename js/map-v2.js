...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // --- City Data ---
  const cities = [
      { id: 'chennai', name: 'Chennai', x: 45, z: -10, isHQ: false, services: 'Premium Residential, Commercial', distance: '120 km', time: '2h 30m' },
      { id: 'walajah', name: 'Walajah', x: 8, z: 0, isHQ: false, services: 'Residential, Renovation', distance: '30 km', time: '45m' },
      { id: 'ranipet', name: 'Ranipet', x: 5, z: -1, isHQ: false, services: 'Residential, Commercial', distance: '15 km', time: '20m' },
      { id: 'melvisharam', name: 'Melvisharam (HQ)', x: 0, z: 0, isHQ: true, services: 'All Services (Headquarters)', distance: '0 km', time: '0m' },
      { id: 'arcot', name: 'Arcot', x: 4, z: 2, isHQ: false, services: 'Residential, Architecture', distance: '2 km', time: '5m' },
      { id: 'vellore', name: 'Vellore', x: -8, z: 1, isHQ: false, services: 'Premium Residential, Commercial', distance: '20 km', time: '30m' },
      { id: 'ambur', name: 'Ambur', x: -25, z: 8, isHQ: false, services: 'Residential, Turnkey', distance: '55 km', time: '1h 10m' },
      { id: 'vaniyambadi', name: 'Vaniyambadi', x: -33, z: 12, isHQ: false, services: 'Residential, Architecture', distance: '75 km', time: '1h 30m' },
      { id: 'bengaluru', name: 'Bengaluru', x: -55, z: -5, isHQ: false, services: 'Luxury Villas, Commercial', distance: '210 km', time: '4h 0m' },
    ];
  ...
  function focusCity(city) {
    ...
    // Close on click outside (already handled in onPointerDown but add close button listener)
