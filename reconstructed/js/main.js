...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (loader) {
    ...
    // If no loader, still handle hash navigation and initialize animations
    initAnimations();
    handleHashNavigation();
  }
  ...
  function initAnimations() {
    ...
    // Safety net: guarantee ALL animated elements are visible after 3s
    // in case any GSAP ScrollTrigger animation fails to trigger
    setTimeout(() => {
      const selectors = [
        'section.section',
        '.section-header', '.section-header h1', '.section-header h2',
        '.section-header h3', '.section-header p', '.text-overline',
        '.divider',
        ...
        '.contact__form-wrapper', '.luxury-contact__panel',
        '.contact__info', '.contact__card',
        '.luxury-footer__top > *',
        '.workflow__step', '.why-us__card', '.why-us__vs-badge',
        '.timeline-content', '[data-reveal]'
      ];
